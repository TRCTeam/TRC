    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a TorrentCoin address (e.g. GC8Lqitqh2uocq4srya3wZM6xMN9NAiKFr)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a TorrentCoin address (e.g. GC8Lqitqh2uocq4srya3wZM6xMN9NAiKFr)"));
